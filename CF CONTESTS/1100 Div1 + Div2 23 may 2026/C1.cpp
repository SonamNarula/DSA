...
// version, you must minimise the sum. You can hack only if you solved all versions of this problem.

// You have an array 𝑎
//  of length 𝑛
//  which consists of non-zero (but possibly negative) integers. You will perform the following
//  operation at most 𝑛 times (possibly none):
